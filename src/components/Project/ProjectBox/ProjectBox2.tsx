...
import ToggleCardProjectPortfolio from './ToggleCardsProject/ToggleCardProjectPortfolio';
...
const ProjectBox2: React.FC<ProjectBoxProps> = ({
  title,
  techno,
  techno1,
  techno2,
  ...
  return (
    <div className="projectbox">
      ...
      <ToggleCardProjectPortfolio imgAlt1="" imgAlt2="" imgAlt3="" />
    </div>
  );
};
