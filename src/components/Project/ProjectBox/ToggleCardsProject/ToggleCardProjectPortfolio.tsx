    ...
    <div className="togglecardproject">
      ...
      >
        <div className="togglecardproject-content">
          ...
          <p>
            Afin de mettre le plus de chances de mon côté et de ne rater aucune opportunité, j'ai
          ...
          <p>
            Le premier: mettre en avant mes compétences en vous permettant de juger en direct de mes
            capacités de Dev. Aujourd'hui je suis à la recherche d'un poste de développeur web front
            et de préférence sur React que j'affectionne particulièrement. J'espère que ce projet
            pourra m'apporter un peu plus de visibilité, et qu'il suscitera suffisamment votre
            intérêt pour que vous aillez envie de me contacter.
          </p>
          <p>Le second: me former en autodidact sur Typescript en créant mon portfolio.</p>
