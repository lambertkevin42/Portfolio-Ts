    ...
    <div className="togglecardproject">
      ...
      >
        <div className="togglecardproject-content">
          ...
          <p>
            Sur ce site on retrouve des annonces représentant des besoins postés par des
            associations (connectées). Les volontaires (connectés) ont la possibilité de candidater
            aux annonces pour apporter l’aide exprimée dans l’annonce de l’association. Une personne
          ...
          <p>
            ...
            maintenir une fluidité dans notre travail d'équipe afin de respecter les délais. Mes
            compétences sur les logiciels de design m'ont permis de créer les contenus graphique de
            notre projet. Côté développement web, j'ai réalisé le responsive design, l'intégration,
            la création des divers composants React et les calls API REST (via axios). J'avais
            également pour responsabilité la gestion et l'optimisation de l'expérience utilisateur.
          </p>
        </div>
      </div>
