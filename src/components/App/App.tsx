  ...
  return (
    <div className="app">
      ...
      <MyCard
        ...
        text2="Geek, passionné de création et de développement, j'accorde une attention toute particulière à l'expérience utilisateur de chacun de mes projets. En espérant que votre expérience ici, sera des plus agréable, je vous laisse me découvrir."
